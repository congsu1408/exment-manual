...
MySQLも現段階のLTSバージョンとなるMySQL8.4へと変更することになりました。

## MySQLバージョンアップ方法 MySQL8.4

これまでのMySQLバージョンは最高でも5.7でしたが、今後はMySQL8.4となります。それに伴い、すべてのユーザーが、MySQL8.4にアップデートが必要となります。  
